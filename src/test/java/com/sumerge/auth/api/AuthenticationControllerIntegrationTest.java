...
import com.sumerge.auth.config.RecaptchaFilter;
...
//        }
    ...
    void recaptchaSuccessSoRegisterSuccess() throws Exception {
        String jsonRequestBody = "{\n" +
                ...
                "  \"password\": \"securePassword123\"\n" +
                "}";
        ResponseEntity<RecaptchaResponse> recaptchaResponse=new ResponseEntity<RecaptchaResponse>(new RecaptchaResponse(true,"","",0.0,""), HttpStatus.OK);
